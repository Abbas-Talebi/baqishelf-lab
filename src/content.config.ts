...
const coverTypeSchema = z.enum(["poster", "square"]).default("poster");
...
const games = defineCollection({
  ...
  schema: z.object({
    ...
    source_image: z.string().optional(), // اضافه شد برای دانلود خودکار
  }),
});
...
const movies = defineCollection({
  ...
  schema: z.object({
    ...
    personal_rating: z.number(),
    year: z.number(),
    status: z.enum(["watched", "dropped", "watching", "planned"]),
    date_watched: z.coerce.date().optional(), // اصلاح شد
    genres: z.array(z.string()).optional(),
    tags: z.array(z.string()).optional(),
    cover: z.string().optional(),
    cover_type: coverTypeSchema,
...
const series = defineCollection({
  ...
  schema: z.object({
    ...
    personal_rating: z.number(),
    year: z.number(),
    status: z.enum(["completed", "watching", "paused", "planned", "dropped"]),
...
const books = defineCollection({
  ...
  schema: z.object({
    ...
    personal_rating: z.number(),
    year: z.number(),
    status: z.enum(["completed", "reading", "planned", "dropped"]),
...
const music = defineCollection({
  ...
  schema: z.object({
    ...
    status: z.enum(["listened", "listening", "planned"]),
